...
MAXRECS = 2
MI_PARAMS = {'BUAR': 900, 'ITNO': 'CLAB01005TEST6', 'STAT': 10, 'ITTY': 'Z95', 'RESP': 'MOVEX', 'ITCL': '9200', 'UNMS': 'EA', 'FUDS': '0.45um RC Syringe Filter', 'ITDS': '0.45um RC Syringe Filter', 'ITGR': 'CON', 'CITN': 'Z95000'}
...
def rest_update_call(program, transaction, params):
    url = build_mi_url(BASE, program, transaction, 100, [])
    result = m3_get(url, params)
...
def main():
    results = rest_update_call(PROGRAM, TRANSACTION, MI_PARAMS)
